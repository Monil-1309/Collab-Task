...
export interface Task {
  ...
  title: string
  description: string
  status: "backlog" | "todo" | "in-progress" | "on-hold" | "done" | "deployed" | "cancelled"
...
const initialTasks: Task[] = [
  {
    ...
    description: "Create a modern and intuitive dashboard layout for better user experience",
    status: "in-progress",
    priority: "high",
    type: "feature",
    ...
    labels: ["design", "ui/ux"],
    subtasks: [
      { id: "s1", title: "Create wireframes", completed: true, createdAt: "2024-01-01" },
      { id: "s2", title: "Design mockups", completed: false, createdAt: "2024-01-02" },
    ],
    comments: [{ id: "c1", text: "Looking great so far!", author: "jane@example.com", createdAt: "2024-01-03" }],
